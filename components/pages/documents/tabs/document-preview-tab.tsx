    ...
    <div className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-md p-4 flex items-start gap-3">
        ...
        <div className="space-y-1">
          <p className="text-sm text-blue-800 font-medium">This is how the documents will display on the Benefits Hub. Please confirm order, titles and descriptions of document cards, you can edit them here.</p>
          {showWizardNextHint && (
            <p className="text-sm text-blue-700">From this stage, clicking the footer Next button will take you to the next step.</p>
          )}
        </div>
      </div>
