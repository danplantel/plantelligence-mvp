        ...
        <ul className="flex gap-4">
          {steps.map((step, index) => (
            <li key={step.name} className="md:flex-1">
              {currentStep > index ? (
                <div className="flex flex-col w-full py-2 pl-4 transition-colors border-l-4 group border-[#DAC286] md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-4">
                  <span className="text-sm font-medium transition-colors text-[#DAC286] ">
                    {step.id}
                  </span>
                ...
                <div
                  className="flex flex-col w-full py-2 pl-4 border-l-4 border-[#DAC286] md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-4"
                  aria-current="step"
                >
                  <span className="text-sm font-medium text-[#b3954b]">
                    {step.id}
                  </span>
                  <span className="text-sm font-medium">{step.name}</span>
                </div>
