...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-lg text-sm font- transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-accent-blue dark:bg-accent-blue text-primary-foreground hover:bg-[#23919C]/90 hover:scale-105 active:scale-95 ease-linear transition-all duration-100",
        destructive:
        ...
        outline:
          "border border-[#efefef] dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm hover:border-accent-blue dark:hover:border-accent-blue active:scale-95 ease-linear transition-all duration-100",
        secondary:
